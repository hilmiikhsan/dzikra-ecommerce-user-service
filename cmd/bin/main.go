...
import (
	...
	"github.com/Digitalkeun-Creative/be-dzikra-ecommerce-user-service/cmd"
...
func main() {
	...
	if len(os.Args) < 2 {
		...
		cmd.RunServerHTTP(serverCmd, os.Args[1:])
		os.Exit(0)
	}
	...
	default:
		...
		cmd.RunServerHTTP(serverCmd, os.Args[2:]) // default to server if invalid command and flags are provided
	}
}
