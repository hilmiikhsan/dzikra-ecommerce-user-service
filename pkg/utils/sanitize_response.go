...
// SanitizeProductResponse sanitizes the CreateOrUpdateProductResponse by removing any potentially harmful content
func SanitizeProductResponse(resp dto.CreateOrUpdateProductResponse, policy *bluemonday.Policy) dto.CreateOrUpdateProductResponse {
